...
from ees_microsoft_teams.microsoft_teams_users import MSTeamsUsers
...
def test_get_all_users(requests_mock, request_return_value, source_users):
    ...
    requests_mock.get('https://graph.microsoft.com/v1.0/users', headers=request_header, json=request_return_value, status_code=200)
    targeted_users = user_obj.get_all_users()
    assert source_users == targeted_users
