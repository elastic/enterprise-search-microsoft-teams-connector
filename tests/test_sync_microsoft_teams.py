...
from ees_microsoft_teams.sync_microsoft_teams import \
    SyncMicrosoftTeams  # noqa
...
def test_add_permissions_to_queue():
    ...
    permission_sync_obj.add_permissions_to_queue("dummy_user", ["permission1", "permission2"])
