...
from ees_microsoft_teams.microsoft_teams_calendars import MSTeamsCalendar
...
def create_calendar_obj():
    ...
    return MSTeamsCalendar('token', "2020-12-04T23:10:36.925Z", "2020-12-05T23:10:36.925Z", {}, logger, configs)
...
def test_calendars_for_cancelled_event():
    ...
    calendar.users.get_all_users = Mock(return_value=mock_users)
    calendar.get_schema_fields = Mock(return_value={'id': 'id', 'last_updated': 'lastModifiedDateTime',
                                                    'title': 'subject', 'created_at': 'createdDateTime'})
    ...
    calendar.client.get = Mock(return_value=mock_calendar_response)
    source_permission, source_documents = calendar.get_calendars([1, 2])
