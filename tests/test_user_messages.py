...
def test_fetch_meeting_recording(chats, source_meeting):
    ...
    targeted_meeting = user_message_obj.fetch_meeting_recording("19:88f620c0269c1f28f48a20d1@thread.v2", chats)
    assert source_meeting == targeted_meeting
...
def test_get_user_tabs(source_tabs, mock_tabs_document):
    ...
    targeted_tabs = user_message_obj.fetch_tabs("123", [1, 2, 3], "2020-12-08T07:17:29.748Z", "2020-12-08T07:17:29.748Z")
    assert source_tabs == targeted_tabs
