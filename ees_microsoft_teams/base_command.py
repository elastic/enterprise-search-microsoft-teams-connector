...
class BaseCommand:
    ...
    def create_jobs_for_user_chats(
        ...
        try:
            ...
            queue.append_to_queue(constant.USER_CHATS_MESSAGE, chat_messages_documents)
    ...
    def create_jobs_for_calendars(
        ...
        try:
            ...
            (
                ...
                calendar_documents,
            ) = sync_microsoft_teams.fetch_calendars(
                calendar_object, ids_list, start_time, end_time
            )
            queue.append_to_queue(constant.CALENDAR, calendar_documents)
